...
export function moveStagedPlacement(state, tileId, toR, toC) {
  ...
  if (from && from.tileId === tileId) {
    state.grid[act.r][act.c] = {
      ...from,
      text: null,
      tileId: null,
      seed: false,
      special: from.special || null,
    };
  }
